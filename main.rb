...
con1 = Contact.new("Harold Holloway","88805553535", "skype_", nil, "@sjkl")
con2 = Contact.new("Helen Hull", "98764534524", nil, "hhull@g.com", "@dsfdsfdsf")
...
puts "#{a_to_s(contacts.find_by_name("He"))}\n\n"
puts "#{a_to_s(contacts.find_by_phone("524"))}\n\n"